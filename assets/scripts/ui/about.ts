 ...
 * 【关于】页面的文案与资料。
 *
 * 文字内容单独放一份，方便直接修改；界面只负责渲染。
 */

import { DONATE_QR_IMAGE } from './about-image'

export const ABOUT = {
  title: '关于',
  subtitle: '一个永久免费的编程入门小工具',
  paragraphs: [
    '哈喽，谢谢你点开【关于】。',
  ...
  developer: 'alucardulad',
  email: 'alucardulad@gmail.com',
  donateTitle: '打赏码',
  donateNote: '如果这个小工具帮到了你，可以扫码请我喝杯咖啡 ☕',
  qrImage: DONATE_QR_IMAGE,
}
